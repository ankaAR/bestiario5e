...
* Lightning Flail. Ataque de arma cuerpo a cuerpo: +11 al ataque, alcance 15 pies (4.5 mts), una criatura. Impacto: 18 (3d8 + 5) puntos de daño contundente plus 22 (5d8) lightning damage. Up to three other creatures of the hellfire engine's choice that it can see within 30 feet of the target must each make a DC 20 Dexterity saving throw, taking 22 (5d8) lightning damage on a failed save, or half as much damage on a successful one.
