...
***Constrict.*** Melee Weapon Attack: +4 al ataque, alcance 10 pies, un objetivo. Impacto: 9 (2d6 + 2) puntos de daño contundente, and a Large or smaller target is grappled (escape DC 12) . Until this grapple ends, the target is restrained, and the blight can't constrict another target.
