...
layout: creature
name: "Kelpie"
tags: [mediana, planta, cr4, tales-from-the-yawning-portal]
cha: 10 (0)
wis: 12 (+1)
int: 7 (-2)
con: 16 (+3)
...
***Slam.*** Ataque de arma cuerpo a cuerpo: +4 al ataque, alcance 10 pies (3 mts), un objetivo. Impacto: 11 (2d8 + 2) puntos de daño perforante. If the target is a Medium or smaller creature, it is grappled (escape DC 12).
