...
layout: creature
name: "Boneclaw"
tags: [grande, no-muerto, cr12, mordenkainens-tome-of-foes]
page_number: 121
cha: 9 (0)
wis: 15 (+2)
int: 13 (+1)
...
***Piercing Claw*** Ataque de arma cuerpo a cuerpo: +8 al ataque, alcance 15 pies (4.5 mts), un objetivo. Impacto: 20 (3d10 + 4) puntos de daño perforante. If the target is a creature, the boneclaw can pull the target up to 10 feet toward itself, and the target is grappled (escape DC 14). The boneclaw has two claws. While a claw grapples a target, the claw can attack only that target.
